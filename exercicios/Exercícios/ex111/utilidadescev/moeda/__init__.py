...
def resumo(num = 0, porcentagemAUM = 10, porcentagemRED = 5, reduz = 0):
    linha()
    print('RESUMO DO VALOR'.center(40))
    linha()
    print(f'Preço analisado: \t{formatar(num)}')
    print(f'Metade do preço: \t{metade(num, True)}')
    print(f'Dobro do preço: \t{dobro(num, True)}')
    print(f'{porcentagemAUM}% de aumento: \t{aumento(num, porcentagemAUM, True)}')
    print(f'{porcentagemRED}% de redução: \t{reduzir(num, porcentagemRED, True)}')
    linha()
